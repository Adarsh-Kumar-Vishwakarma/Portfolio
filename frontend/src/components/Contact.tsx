  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-[#181c23] font-mono px-2 sm:px-0 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-8 sm:mb-12 md:mb-16" ref={contactRef}>
          <div id="contact" className="inline-flex flex-col items-center gap-2 mb-4 sm:mb-6 font-mono scroll-mt-20 bg-[#23272e] border-2 border-[#4fd1c5] rounded-t-xl px-3 sm:px-4 md:px-6 py-2">
            <div className="flex items-center gap-2">
              <span className="text-[#4fd1c5] font-bold text-xs sm:text-sm">$</span>
              <span className="text-[#63b3ed] tracking-wider text-xs sm:text-sm md:text-base">./contact --init</span>
            </div>
            <SystemStatusBar />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
          <div className="mb-6 lg:mb-0">
            ...
            <div className="bg-[#23272e] border-2 border-[#4fd1c5] rounded-xl shadow-lg p-4 sm:p-6 md:p-8 font-mono relative overflow-hidden">
              <div className="absolute left-0 top-0 w-full flex items-center px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-[#181c23] border-b border-[#4fd1c5] rounded-t-xl">
                <span className="text-[#4fd1c5] font-bold mr-1 sm:mr-2 text-xs sm:text-sm">$</span>
                <span className="text-[#63b3ed] tracking-wider text-xs sm:text-sm">cat contact-info.txt</span>
              </div>
              <div className="mt-8 sm:mt-10 mb-4 sm:mb-6 text-center">
                <h3 className="text-lg sm:text-xl md:text-2xl text-[#f6e05e] font-bold mb-2">Contact Information</h3>
                <p className="text-[#a0aec0] text-xs sm:text-sm mb-3 sm:mb-4">// Let's connect! You can reach me via the details below or through the form.</p>
              </div>
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="bg-[#181c23] p-2 sm:p-3 rounded-lg border border-[#4fd1c5] flex-shrink-0">
                    <Mail className="text-[#4fd1c5] h-5 w-5 sm:h-6 sm:w-6" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-[#a0aec0] text-xs sm:text-sm">Email</p>
                    <p className="text-[#f7fafc] font-semibold text-xs sm:text-sm md:text-base break-all">adarshvish2606@email.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="bg-[#181c23] p-2 sm:p-3 rounded-lg border border-[#4fd1c5] flex-shrink-0">
                    <Phone className="text-[#4fd1c5] h-5 w-5 sm:h-6 sm:w-6" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-[#a0aec0] text-xs sm:text-sm">Phone</p>
                    <p className="text-[#f7fafc] font-semibold text-xs sm:text-sm md:text-base">+91 9930635004</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="bg-[#181c23] p-2 sm:p-3 rounded-lg border border-[#4fd1c5] flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24"><path fill="#4fd1c5" d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.472-.148-.67.15-.198.297-.767.966-.94 1.164-.173.198-.347.223-.644.075-.297-.149-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.151-.174.2-.298.3-.497.099-.198.05-.372-.025-.52-.075-.148-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.372-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.1 3.2 5.077 4.366.71.306 1.263.489 1.695.626.712.227 1.36.195 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.288.173-1.413-.074-.124-.272-.198-.57-.347zm-5.421 6.318h-.001a8.77 8.77 0 0 1-4.473-1.231l-.321-.19-3.326.874.889-3.24-.209-.332A8.725 8.725 0 0 1 2.2 12.045c0-4.825 3.936-8.761 8.764-8.761 2.342 0 4.544.913 6.2 2.569a8.68 8.68 0 0 1 2.563 6.192c-.003 4.825-3.939 8.761-8.765 8.761zm7.149-15.91A10.42 10.42 0 0 0 10.964 0C5.006 0 .199 4.807.199 10.744c0 1.892.496 3.747 1.442 5.377L.057 23.25a1.003 1.003 0 0 0 1.225 1.225l7.13-1.584a10.73 10.73 0 0 0 4.552 1.047h.005c5.957 0 10.764-4.807 10.764-10.744 0-2.86-1.115-5.548-3.146-7.744z"/></svg>
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-[#a0aec0] text-xs sm:text-sm">WhatsApp</p>
                    <a href="https://wa.me/919930635004?text=Hello%20Adarsh%2C%20I%20came%20across%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20potential%20opportunity%20or%20connect%20for%20a%20professional%20conversation." target="_blank" rel="noopener noreferrer" className="text-[#25D366] font-semibold hover:underline text-xs sm:text-sm md:text-base break-all">Message on WhatsApp</a>
                  </div>
                </div>
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="bg-[#181c23] p-2 sm:p-3 rounded-lg border border-[#4fd1c5] flex-shrink-0">
                    <MapPin className="text-[#4fd1c5] h-5 w-5 sm:h-6 sm:w-6" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-[#a0aec0] text-xs sm:text-sm">Location</p>
                    <p className="text-[#f7fafc] font-semibold text-xs sm:text-sm md:text-base">Nalasopara, Palghar</p>
                  </div>
                </div>
              </div>
              <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-[#181c23] rounded-lg border border-[#4fd1c5]">
                <h4 className="text-base sm:text-lg font-semibold text-[#f6e05e] mb-2 sm:mb-3">Let's Connect</h4>
                <p className="text-[#a0aec0] mb-3 sm:mb-4 text-xs sm:text-sm">// I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision.</p>
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center">
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="w-full sm:w-auto border-[#4fd1c5] text-[#4fd1c5] hover:bg-[#4fd1c5] hover:text-[#181c23] font-mono text-xs sm:text-sm"
          ...
          <div>
            ...
            <div className="bg-[#23272e] border-2 border-[#4fd1c5] rounded-xl shadow-lg p-4 sm:p-6 md:p-8 font-mono relative overflow-hidden">
              <div className="absolute left-0 top-0 w-full flex items-center px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 bg-[#181c23] border-b border-[#4fd1c5] rounded-t-xl">
                <span className="text-[#4fd1c5] font-bold mr-1 sm:mr-2 text-xs sm:text-sm">$</span>
                <span className="text-[#63b3ed] tracking-wider text-xs sm:text-sm">curl -X POST /contact</span>
              </div>
              <div className="mt-8 sm:mt-10 mb-4 sm:mb-6 text-center">
                <h3 className="text-lg sm:text-xl text-[#f6e05e] font-bold mt-2 mb-1">Contact the Developer</h3>
                <p className="text-[#a0aec0] text-xs sm:text-sm">// Drop a message below. All fields are required.</p>
              </div>
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    <label htmlFor="name" className="block text-xs font-semibold text-[#f6e05e] mb-1.5 sm:mb-2 uppercase tracking-wider">
                    ...
                    <Input
                      ...
                      required
                      className="bg-[#181c23] border-[#4fd1c5] text-[#f7fafc] focus:border-[#f6e05e] font-mono placeholder-[#718096] text-sm"
                      placeholder="Your Name"
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-xs font-semibold text-[#f6e05e] mb-1.5 sm:mb-2 uppercase tracking-wider">
                      <span className="text-[#4fd1c5]">email</span>
                    </label>
                    <Input
                      type="email"
                      id="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-xs font-semibold text-[#f6e05e] mb-1.5 sm:mb-2 uppercase tracking-wider">
                    <span className="text-[#4fd1c5]">subject</span>
                  </label>
                  <Input
                    type="text"
                    id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-xs font-semibold text-[#f6e05e] mb-1.5 sm:mb-2 uppercase tracking-wider">
                    <span className="text-[#4fd1c5]">message</span>
                  </label>
                  <Textarea
                    id="message"
                    name="message"
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#4fd1c5] hover:bg-[#63b3ed] text-[#181c23] font-bold py-2.5 sm:py-3 font-mono transition-colors duration-200 text-sm sm:text-base"
                  size="lg"
                  disabled={isSubmitting}
                >
                  {isSubmitting ? (
                    <Loader2 className="mr-2 animate-spin h-4 w-4 sm:h-5 sm:w-5" />
                  ) : (
              ...
              <div className="mt-6 sm:mt-8 text-center text-[#718096] text-xs">
